...
void World::CreateWorld()
{
	...
	Elm->list.push_back(entities[i++]);
	entities.PushBack(new Monster(MONSTER_AGG, "cerberus", "The guardian of the gate that connect both worlds... The end is near, if you kill him you will be able to escape, but this won't be easy.\n", 600, 100, 10, 5000, 0));
	ExitUnderworld->list.push_back(entities[i++]);
